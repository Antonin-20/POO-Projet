...
class Manoir:
    ...
    def __init__(self, room_catalog):
        ...
        self.grille[0][2] = Piece("entrance", (0, 2), "haut",[])        #on considère que le joueur n'a pas d'objets spéciaux au début
        self.grille[8][2] = Piece("antechamber", (8, 2), "haut",[])     #et à la fin on s'en fiche
